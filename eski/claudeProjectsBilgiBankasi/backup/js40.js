        ...
        function updateSyncStatus(drift) {
            ...
            queueRAF(() => {
                ...
                if (drift < TIER1_THRESHOLD) {
                    ...
                    statusText.textContent = 'âŒ Senkronizasyon kaybÄ±';
        ...
        function clearOwnerTasks() {
            ...
            debugLog('ğŸ§¹ Owner tasks cleared');
        }
...
AFRAME.registerComponent('video-texture-fix', {
    ...
    tick: function (time) {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('ğŸ¬ VR Cinema ULTRA - Optimized v3.7 (P2P WebTorrent Support)');
            updateQualityCapUI();
            ...
            if (scene) {
                ...
                sceneEnterVRHandler = () => {
                    ...
                    if (cursor) {
                        ...
                        debugLog('ğŸ‘“ VR mode: Raycaster enabled');
                    }
                };
                ...
                sceneExitVRHandler = () => {
                    ...
                    if (cursor) {
                        ...
                        debugLog('ğŸ‘“ VR mode exit: Raycaster disabled');
                    }
                };
