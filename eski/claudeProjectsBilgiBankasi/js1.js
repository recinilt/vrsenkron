let isSeeking = false;
        let isHardSeeking = false; // Ã¢Å“â€¦ FIX: syncVideo ve listenKeyframes ÃƒÂ§akÃ„Â±Ã…Å¸masÃ„Â±nÃ„Â± ÃƒÂ¶nlemek iÃƒÂ§in

        
        // ==================== CONFIG ====================
        // Firebase YapÃ„Â±landÃ„Â±rmasÃ„Â±
const firebaseConfig = {
    ...
    appId: "1:724648238300:web:dceba8c536e8a5ffd96819"
        ...
        // ==================== OPTIMIZED CONSTANTS ====================
        const SYNCCHECKINTERVAL = 750; // Ã¢Å“â€¦ FIX: drift timing sorunu iÃƒÂ§in artÃ„Â±rÃ„Â±ldÃ„Â±
        ...
        const PRELOAD_BUFFER_SECONDS = 9; // Ã¢Å“â€¦ FIX: 7 -> 9 saniye buffer
        ...
        const LARGE_DRIFT_THRESHOLD = 9000; // Ã¢Å“â€¦ FIX: 3000 -> 9000ms (9sn sonra hard seek)
