                                ...
                                .then(viewersSnapshot => {
                                    ...
                                    if (viewers) {
                                        ...
                                        if (newOwner === currentUser.uid) {
                                            ...
                                            isRoomOwner = true;
                                            debugLog('ÄŸÅ¸â€˜â€˜ Ownership transferred to you');
                                        }
                                    }
                                });
                        }
        ...
        function updateRoomInfoDisplay() {
            ...
            getCachedElement('room-name-display').textContent = currentRoomData.name + (isRoomOwner ? ' ÄŸÅ¸â€˜â€˜' : '');
            updateViewerCount();
        }
        
        // Ã¢Å“â€¦ FIX #12: DOM thrashing azaltma - queueRAF kullan
            ...
            db.ref('rooms/' + currentRoomId + '/activeViewers').once('value')
                .then(snapshot => {
                    ...
                    queueRAF(() => {
                        ...
                        if (viewerElement) {
                            viewerElement.textContent = `ÄŸÅ¸â€˜Â¥ ${count} izleyici`;
                        }
                    });
                })
                .catch(() => {});
