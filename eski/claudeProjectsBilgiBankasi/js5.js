    ...
    if (type === 'hls') {
        if (window.Hls && Hls.isSupported()) {
            hlsInstance = new Hls({
                ...
                abrBandWidthFactor: 0.9, // Ã¢Å“â€¦ FIX: 0.8 -> 0.9 (kalite dÃƒÂ¼Ã…Å¸ÃƒÂ¼rme iÃƒÂ§in daha muhafazakar)
                abrBandWidthUpFactor: 0.6 // Ã¢Å“â€¦ FIX: 0.7 -> 0.6 (yukarÃ„Â± geÃƒÂ§iÃ…Å¸te daha dikkatli)
            });
