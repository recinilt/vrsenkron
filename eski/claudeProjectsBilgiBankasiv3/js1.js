let isSeeking = false;
        let isHardSeeking = false; // âœ… FIX: syncVideo ve listenKeyframes Ã§akÄ±ÅŸmasÄ±nÄ± Ã¶nlemek iÃ§in
...
const firebaseConfig = {
    ...
    appId: "1:724648238300:web:dceba8c536e8a5ffd96819"
        ...
        // ==================== OPTIMIZED CONSTANTS ====================
        const SYNCCHECKINTERVAL = 750; // âœ… FIX: drift timing sorunu iÃ§in artÄ±rÄ±ldÄ±
        ...
        const PRELOAD_BUFFER_SECONDS = 9; // âœ… FIX: 7 -> 9 saniye buffer
        ...
        const LARGE_DRIFT_THRESHOLD = 9000; // âœ… FIX: 3000 -> 9000ms (9sn sonra hard seek)
