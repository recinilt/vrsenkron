    ...
    const handleLoadedMetadata = () => {
        debugLog('ğŸ“¹ Video metadata loaded, duration:', videoElement.duration);
    };
    ...
    if (isP2PRoom && !isRoomOwner) {
        ...
        try {
            showP2PStatus('ğŸ” P2P baÄŸlantÄ±sÄ± kuruluyor...', 0);
            ...
            videoFile.renderTo(videoElement, { autoplay: false }, (err) => {
                if (err) {
                    ...
                    updateP2PStatus('âŒ Video yÃ¼klenemedi', 0);
                } else {
            ...
            updateP2PStatus('âŒ P2P hatasÄ±: ' + e.message, 0);
        }
        ...
        if (selectedLocalFile) {
            ...
            showP2PStatus('ğŸ“¤ PaylaÅŸÄ±lÄ±yor...', 100);
        }
    } else {
        // Normal URL modu
    ...
    if (isRoomOwner) {
        ...
        const buttons = [
            ...
            { text: 'âª', position: '0.2 0 0', event: 'rewind' },
