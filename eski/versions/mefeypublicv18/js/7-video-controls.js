// ============================================
// VİDEO KONTROL FONKSİYONLARI - ODA SAHİBİ ODAKLI
// ============================================
...
// ESKİ togglePlayPause (geriye uyumluluk için)
...
function stopVideo() {
    // STOP herkes tarafından kullanılabilir (ODA SAHİBİ ODAKLI)
    if (!videoElement) {
        alert('Video henüz yüklenmedi!');
        return;
    }
    
    // Eğer oda sahibi değilsen uyarı göster ama yine de çalıştır
    if (!canControlVideo()) {
        console.log('⚠️ Oda sahibi değilsiniz, ama stop komutu gönderiliyor');
    }
...
console.log('   → Play/Pause ayrı butonlar');
console.log('   → Stop herkes tarafından kullanılabilir');
