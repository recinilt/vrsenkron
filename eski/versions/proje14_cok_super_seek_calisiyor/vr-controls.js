// ============================================
// VR KONTROL PANELİ + SEEK BAR - OPTİMİZE EDİLMİŞ
// Interval Cleanup + Debug Mode
// ============================================
...
function createVRSeekBar(panel) {
    ...
    bgBar.addEventListener('click', (evt) => {
        ...
        debugLog('🎯 Seek bar:', (clamped * 100).toFixed(1), '%');
    ...
    // Update loop - Interval referansını sakla
...
function moveScreen(dir) {
    ...
    debugLog('📺 Ekran:', screenPosition);
}

debugLog('✅ VR Controls yüklendi - Optimize Edilmiş Versiyon');
